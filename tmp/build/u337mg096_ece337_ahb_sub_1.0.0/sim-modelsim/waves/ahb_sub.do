...
add wave -noupdate /tb_ahb_sub/BFM/clk
add wave -noupdate /tb_ahb_sub/BFM/hsel
add wave -noupdate /tb_ahb_sub/BFM/haddr
add wave -noupdate /tb_ahb_sub/BFM/hsize
add wave -noupdate /tb_ahb_sub/BFM/htrans
add wave -noupdate /tb_ahb_sub/BFM/hburst
add wave -noupdate /tb_ahb_sub/BFM/hwrite
add wave -noupdate /tb_ahb_sub/BFM/hwdata
add wave -noupdate /tb_ahb_sub/BFM/hrdata
add wave -noupdate /tb_ahb_sub/BFM/hresp
add wave -noupdate /tb_ahb_sub/BFM/hready
add wave -noupdate /tb_ahb_sub/BFM/last_hrdata_read
add wave -noupdate /tb_ahb_sub/BFM/num_transactions_left
add wave -noupdate /tb_ahb_sub/BFM/new_transaction
add wave -noupdate /tb_ahb_sub/BFM/bus_state
add wave -noupdate /tb_ahb_sub/BFM/i
add wave -noupdate /tb_ahb_sub/BFM/minaddr
add wave -noupdate /tb_ahb_sub/BFM/maxaddr
add wave -noupdate -divider DUT
add wave -noupdate /tb_ahb_sub/DUT/clk
add wave -noupdate /tb_ahb_sub/DUT/n_rst
add wave -noupdate /tb_ahb_sub/DUT/hsel
add wave -noupdate /tb_ahb_sub/DUT/hwrite
add wave -noupdate /tb_ahb_sub/DUT/haddr
add wave -noupdate /tb_ahb_sub/DUT/htrans
add wave -noupdate /tb_ahb_sub/DUT/hsize
add wave -noupdate /tb_ahb_sub/DUT/hwdata
add wave -noupdate /tb_ahb_sub/DUT/hburst
add wave -noupdate /tb_ahb_sub/DUT/status_reg
add wave -noupdate /tb_ahb_sub/DUT/output_data
add wave -noupdate /tb_ahb_sub/DUT/err_reg
add wave -noupdate /tb_ahb_sub/DUT/act_mode
add wave -noupdate /tb_ahb_sub/DUT/hready
add wave -noupdate /tb_ahb_sub/DUT/hresp
add wave -noupdate /tb_ahb_sub/DUT/hrdata
add wave -noupdate /tb_ahb_sub/DUT/handshake
add wave -noupdate /tb_ahb_sub/DUT/bias_reg
add wave -noupdate /tb_ahb_sub/DUT/ctrl_reg
add wave -noupdate /tb_ahb_sub/DUT/wr_en_push
add wave -noupdate /tb_ahb_sub/DUT/is_weight
...
WaveRestoreCursors {{Cursor 1} {144334 ps} 0}
...
update
WaveRestoreZoom {0 ps} {257250 ps}
